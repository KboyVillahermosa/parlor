...
if(isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO tblinquires (Name, Email, ResidentialAddress, TargetLocation, ContactNumber) 
              VALUES ('$name', '$email', '$address', '$location', '$phone')";
    		...
    		<div class="row no-gutters d-md-flex justify-content-end">
    			<div class="one-forth d-flex ">
    				<div class="text">
						...
						<span class="subheading">"Vi Vogue Online Salon Franchise is committed to protecting the privacy of our applicants. <br>
							 ...
							 If you have any questions or concerns regarding our data privacy practices, please contact us."
							 <br>click below to go Facebook Page</br>
							 <a href="https://www.facebook.com/profile.php?id=61557668187380">
							 Email Address: janmontejoo@gmail.com <br>
							 Contact Number: 09257148999</span>
							</a>
			          </form>
					...
					<div class="one-third">
						<div class="img" style="background-image: url(images/inquire.jpg);">
