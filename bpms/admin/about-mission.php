...
$pagedes=$_POST['pagedes'];
    ...
    $query=mysqli_query($con,"update tblpage set PageTitle='$pagetitle',PageDescription='$pagedes' where  PageType='mission'");
    if ($query) {
    $msg="Mission has been updated.";
  }
  else
    {
	...
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">Update Mission</h3>
...
$ret=mysqli_query($con,"select * from  tblpage where PageType='mission'");
$cnt=1;
