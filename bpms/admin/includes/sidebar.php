  <div class=" sidebar" role="navigation">
          ...
          <ul class="nav" id="side-menu">
            ...
            <li>
              ...
              <ul class="nav nav-second-level collapse">
                ...
                <li>
                  <a href="manage-branch.php">Manage Branch</a>
                </li>
              </ul>
              <!-- /nav-second-level -->
            </li>
    ...
    <li>
            ...
            <li>
              <a href="inquires.php" class="chart-nav"><i class="fa fa-search nav_icon"></i>Inquires</a>
            </li>
            <li>
              <a href="branch-sales.php" class="chart-nav"><i class="fa fa-search nav_icon"></i>Branches Total Sales</a>
            </li>
