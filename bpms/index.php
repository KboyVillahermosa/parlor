						...
						<div class="appointment-wrap">
							...
							<form action="#" method="post" class="appointment-form">
								<div class="row">
									...
									<div class="col-sm-12">
										<div class="form-group">
											<div class="select-wrap">
												<div class="icon"><span class="ion-ios-arrow-down"></span></div>
												<select name="no-of-heads id=" noheads" required="true"
													class="form-control">
								...
								<span class="subheading">"Vi Vogue Online Salon Reservation is committed to protecting
									the privacy of our customers. <br>
									We collect and use your personal information in accordance with Republic Act No.
									10173 or the <br>
									Data Privacy Act of 2012 and our privacy policy. By using our website to book
									appointments, <br>
									you consent to the collection and use of your personal information in accordance
									with this policy.<br>
									If you have any questions or concerns regarding our data privacy practices, please
									contact us."</span>
							</form>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-md-12 ftco-animate">
					<div class="appointment-history">
						...
						<button id="openModalBtn" class="modal-btn">More Appointment</button>

						<div id="myModal" class="modal">
							<div class="modal-content">
								<span class="close">&times;</span>
								<?php if (count($aggregatedAppointments) > 5) { ?>
									<div class="more-appointments hidden">
										<h3>More Appointments</h3>
										<ul class="appointments-list">
											<?php foreach ($aggregatedAppointments as $key => $appointment) {
												if ($key >= 5) { ?>
													<li>
														<div class="appointment-details">
															<div class="appointment-meta">
